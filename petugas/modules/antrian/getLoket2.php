...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ( $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' )) {
    ...
    $result_nomor = $mysqli->query("SELECT no_antrian FROM antrian WHERE tanggal='$hari_ini' AND loket='$loket' AND status IN ('1','2') ORDER BY no_antrian DESC LIMIT 1")
...
?>
    <div class="p-2 text-xs-center bg-pink media-left media-middle">
        <h1 id="loket2_tiket" style="color:#fff"><?php echo $no_antrian; ?></h1>
    </div>
